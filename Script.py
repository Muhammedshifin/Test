...
<b>✮ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝚆𝚒𝚝𝚑𝚘𝚞𝚝 𝚂𝚎𝚛𝚟𝚎𝚛 </b>
<b>✮ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: 𝚅2.2.43</b>
<b>✮ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂: <a href=https://t.me/myreeeeeeea>𝐖𝐚𝐳𝐞𝐞𝐦</a></b>
<b>✮ 𝙲𝙷𝙰𝙽𝙽𝙴𝙻: <a href=https://t.me/sinimapremi>𝐌𝐚𝐒𝐓𝐞𝐑</a></b>"""
...
𝐇𝐞𝐥𝐩 𝐭𝐨 𝐑𝐞𝐦𝐨𝐯𝐞 𝐁𝐚𝐜𝐤𝐠𝐫𝐨𝐮𝐧𝐝 𝐨𝐧 𝐲𝐨𝐮𝐫 𝐩𝐡𝐨𝐭𝐨

𝐂𝐨𝐦𝐦𝐚𝐧𝐝👇

𝐒𝐞𝐧𝐝 𝐌𝐞 𝐢𝐦𝐚𝐠𝐞 𝐀𝐧𝐝 𝐜𝐥𝐢𝐜𝐤 𝐑𝐞𝐦𝐨𝐯𝐞 𝐁𝐆"""
    
    STICKERG_TXT ="""𝐇𝐞𝐫𝐞 𝐢𝐬 𝐌𝐲 𝐬𝐭𝐢𝐜𝐤𝐞𝐫 𝐌𝐨𝐝𝐮𝐥𝐞💝

𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐚𝐧𝐝 𝐮𝐬𝐠𝐞🎗

𝐔𝐬𝐚𝐠𝐞🤝

𝐈 𝐰𝐢𝐥𝐥 𝐠𝐢𝐯𝐞 𝐲𝐨𝐮 𝐚 𝐬𝐭𝐢𝐜𝐤𝐞𝐫 𝐮𝐬𝐢𝐧𝐠 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐣𝐮𝐬𝐭 𝐩𝐫𝐞𝐬𝐬 𝐚𝐧𝐝 𝐜𝐥𝐢𝐜𝐤 𝐚𝐝𝐝 𝐭𝐨 𝐬𝐭𝐢𝐜𝐤𝐞𝐫𝐬
...
𝐓𝐡𝐢𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐠𝐞𝐭 𝐲𝐨𝐮𝐫 𝐜𝐮𝐫𝐫𝐞𝐧𝐭 𝐩𝐢𝐧𝐠 𝐮𝐬𝐢𝐧𝐠 /ping"""
    ...
    LYRICS_TXT ="""𝗧𝗵𝗶𝘀 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 𝘂𝘀𝗶𝗻𝗴 𝗳𝗼𝗿 𝗙𝗶𝗻𝗱 𝗠𝘂𝘀𝗶𝗰 𝗹𝘆𝗿𝗶𝗰𝘀

𝗨𝘀𝗮𝗴𝗲
𝗦𝗲𝗻𝗱 𝗺𝗲 𝗮 𝘀𝗼𝗻𝗴 𝗡𝗮𝗺𝗲
𝗔𝗻𝗱 𝗿𝗲𝗽𝗹𝘆 𝘁𝗵𝗮𝘁 𝘀𝗼𝗻𝗴 /lyrics"""
    
    PROPOSE_TXT ="""𝗧𝗵𝗶𝘀 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 𝗼𝗻𝗹𝘆 𝘀𝗶𝗻𝗴𝗹𝗲𝘀
𝗜𝗳 𝘆𝗼𝘂 𝗹𝗶𝗸𝗲 𝗮 𝗴𝗶𝗿𝗹 𝗱𝗼 𝘆𝗼𝘂 𝘄𝗮𝗻𝘁 𝘁𝗼 𝗶𝗺𝗽𝗿𝗲𝘀𝘀 𝘁𝗵𝗮𝘁 𝗴𝗶𝗿𝗹 𝘄𝗶𝘁𝗵 𝗯𝗲𝗮𝘂𝘁𝗶𝗳𝘂𝗹 𝗽𝗿𝗼𝗽𝗼𝘀𝗲
𝗜 𝘄𝗶𝗹𝗹 𝗴𝗶𝘃𝗲 𝘆𝗼𝘂 𝘀𝗼𝗺𝗲 𝗽𝗿𝗼𝗽𝗼𝘀𝗲 𝘄𝗼𝗿𝗱𝘀 𝘂𝘀𝗶𝗻𝗴 𝘁𝗵𝗶𝘀 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 /propose"""
    
    SOURCE_TXT ="""ɪᴀᴍ ᴀ ᴘᴜʙʟɪᴄ ᴘʀᴏᴊᴇᴄᴛ ʏᴏᴜ ʜᴀᴠᴇᴛᴏ ᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ ʙᴏᴛ ʟɪᴋᴇ ᴍᴇ
ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ sᴏʏʀᴄᴇ ᴄᴏᴅᴇ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛᴇʟᴇɢʀᴀᴍ ᴀsᴋ ᴛᴏ ᴍʏ ᴏᴡɴᴇʀ ɪɴ ɪɴsᴛᴀɢʀᴀᴍ ᴍʏ ᴏᴡɴᴇʀ ɢɪᴠᴇ ʏᴏᴜ ᴛʜᴇ sᴏᴜʀᴄᴇ ᴄᴏᴅe"""

...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k=await query.message.edit('<b>നിങ്ങൾ ആവശ്യപ്പെട്ട മൂവി എനിക്ക് എന്റെ ഡാറ്റാബേസിൽ നിന്നും കണ്ടെത്താൻ കഴിഞ്ഞില്ല ഈ മൂവി ഗ്രൂപ്പിൽ ആഡ് ചെയ്യാൻ വേണ്ടി മുകളിൽ കാണിച്ചതുപോലെ അഡ്മിൻ  മെൻഷൻ ചെയ്യുക </b>/n/n📮 Mᴇɴᴛɪᴏɴ ➪ <code> @admin Movie Name!</code>/n/n eg:- <code> @admin kgf 2 </code>/n/n<b>or Contact owner @Master_brooi</b>', reply_markup=InlineKeyboardMarkup(btn))

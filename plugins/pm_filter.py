...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('𝚃𝙷𝙸𝚂 𝙼𝙾𝚅𝙸𝙴 I𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝙾𝚁 𝙰𝙳𝙳𝙴𝙳 𝚃𝙾 𝙳𝙰𝚃𝚂𝙱𝙰𝚂𝙴 💌 താങ്കൾ  ഉദ്ദേശിച്ച  മൂവി  എനിക്ക്  എന്റെ  𝗱𝗮𝘁𝗮  𝗯𝗮𝘀𝗲ൽ  നിന്നും  കണ്ടെത്താൻ  സാധിച്ചിട്ടില്ല
ഈ  മൂവി  𝗮𝗱𝗱  ചെയ്യാൻ  വേണ്ടി  @𝗮𝗱𝗺𝗶𝗻  എന്ന്  ടൈപ്  ചെയ്തു  മൂവിയുടെ
𝗻𝗮𝗺𝗲  അയക്കുക😊
👇
𝗲𝘅𝗮𝗺𝗯𝗹𝗲 @𝗮𝗱𝗺𝗶𝗻 𝗸𝘂𝗿𝘂𝗽𝗽')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons= [[
            InlineKeyboardButton('♥️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ♥️', url='https://github.com/Muhammedshifin/Ajax-Extra-Features')
            ],[

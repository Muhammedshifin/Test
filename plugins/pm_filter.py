...
NOTFOUND ="""<b>ക്ഷമിക്കണം താങ്കൾ ഉദ്ദേശിച്ച മൂവി എനിക്ക് എന്റെ Data base ൽ നിന്നും കണ്ടെത്താൻ കഴിഞ്ഞില്ല... ഈ മൂവി ഗ്രൂപ്പിൽ add ചെയ്യാൻ മുകളിൽ കാണിച്ച പോലെ അഡ്മിൻ നെ Mention ചെയ്യുക...💘</b>
𝗠𝗲𝗻𝘁𝗶𝗼𝗻 :- <code>@admin Movie Name</code>
<b>Eg:-</b> <code>@admin Rorschach 2022</code>
അതിനു ശേഷം chek my Pm എന്ന ബട്ടനിൽ ക്ലിക്ക് ചെയ്ത് Start കൊടുക്കുക """
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>𝙃𝙚𝙧𝙚 𝙞𝙨 𝙬𝙝𝙖𝙩 𝙞𝙨 𝙛𝙤𝙪𝙣𝙙 𝙮𝙤𝙪𝙧 𝗠𝗼𝗩𝗶𝗲:{search}\n👤𝙍𝙚𝙦𝙪𝙚𝙨𝙩𝙚𝙙 𝘽𝙮: {message.from_user.mention}\n👥𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆: {message.chat.title}</b>"
 
    if imdb and imdb.get('poster'):
        try:
            await message.reply_photo(photo="https://telegra.ph/file/380dc24164902942250aa.jpg", caption=cap[:1024],
                               reply_markup=InlineKeyboardMarkup(btn))
